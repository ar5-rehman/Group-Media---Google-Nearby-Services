...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    View view;
    Context context;
    static UsersDialogFragment usersDialogFragment;

    public MyAdapter(Context context,List<String> device)
    {
        this.context = context;
        userList = device;
    }

    static public void dismissDialog(UsersDialogFragment dialogFragment)
    {
