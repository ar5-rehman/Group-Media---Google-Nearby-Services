...
public class MediaAdapter extends RecyclerView.Adapter<MediaAdapter.Holder> implements Filterable {
    ...
    public MediaAdapter(Context context, List<SongsModel> allMusicTracks,MediaPlayer mediaPlayer) {
    ...
    @NonNull
    @Override
    public MediaAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MediaAdapter.Holder holder, int position) {
