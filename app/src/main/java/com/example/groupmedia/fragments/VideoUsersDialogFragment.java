...
public class VideoUsersDialogFragment extends DialogFragment {

    RecyclerView recyclerView;
    RecyclerView.Adapter mAdapter;
    RecyclerView.LayoutManager layoutManager;

    public VideoUsersDialogFragment()
    {

    }

    public VideoUsersDialogFragment(MyVideoAdapter myAdapter) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if(AudioActivity.userName!=null) {
            View view = inflater.inflate(R.layout.fragment_video_users_dialog, container, false);
